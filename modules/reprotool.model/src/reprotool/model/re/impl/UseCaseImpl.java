...
import reprotool.model.re.UseCase;
import reprotool.model.re.UseCaseStep;
 ...
 * <ul>
 *   <li>{@link reprotool.model.re.impl.UseCaseImpl#getPrimaryActor <em>Primary Actor</em>}</li>
 *   <li>{@link reprotool.model.re.impl.UseCaseImpl#getUseCaseSteps <em>Use Case Steps</em>}</li>
 *   <li>{@link reprotool.model.re.impl.UseCaseImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UseCaseImpl extends EObjectImpl implements UseCase {
	...
	protected EClass eStaticClass() {
		return RePackage.Literals.USE_CASE;
	}
		...
		if (primaryActor != null && primaryActor.eIsProxy()) {
			...
			if (primaryActor != oldPrimaryActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RePackage.USE_CASE__PRIMARY_ACTOR, oldPrimaryActor, primaryActor));
			}
		}
		return primaryActor;
	}
	...
	public void setPrimaryActor(Actor newPrimaryActor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RePackage.USE_CASE__PRIMARY_ACTOR, oldPrimaryActor, primaryActor));
	}
	...
	public EList<UseCaseStep> getUseCaseSteps() {
		if (useCaseSteps == null) {
			useCaseSteps = new EObjectContainmentEList<UseCaseStep>(UseCaseStep.class, this, RePackage.USE_CASE__USE_CASE_STEPS);
		}
		return useCaseSteps;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RePackage.USE_CASE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RePackage.USE_CASE__USE_CASE_STEPS:
