 ...
 * <ul>
 *   <li>{@link reprotool.model.linguistic.sentenceparts.impl.GotoTargetImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GotoTargetImpl extends SentencePartImpl implements GotoTarget {
	...
	protected EClass eStaticClass() {
		return SentencepartsPackage.Literals.GOTO_TARGET;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SentencepartsPackage.GOTO_TARGET__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(UseCaseStep newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SentencepartsPackage.GOTO_TARGET__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SentencepartsPackage.GOTO_TARGET__TARGET:
