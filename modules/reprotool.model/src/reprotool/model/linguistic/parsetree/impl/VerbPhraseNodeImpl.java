 ...
 * <ul>
 *   <li>{@link reprotool.model.linguistic.parsetree.impl.VerbPhraseNodeImpl#getChildNodes <em>Child Nodes</em>}</li>
 *   <li>{@link reprotool.model.linguistic.parsetree.impl.VerbPhraseNodeImpl#getParentNode <em>Parent Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VerbPhraseNodeImpl extends EObjectImpl implements VerbPhraseNode {
	...
	protected EClass eStaticClass() {
		return ParsetreePackage.Literals.VERB_PHRASE_NODE;
	}
	...
	public EList<ParseNode> getChildNodes() {
		if (childNodes == null) {
			childNodes = new EObjectContainmentEList<ParseNode>(ParseNode.class, this, ParsetreePackage.VERB_PHRASE_NODE__CHILD_NODES);
		}
		return childNodes;
	}
	...
	public NotificationChain basicSetParentNode(InnerParseNode newParentNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParsetreePackage.VERB_PHRASE_NODE__PARENT_NODE, oldParentNode, newParentNode);
	...
	public void setParentNode(InnerParseNode newParentNode) {
		if (newParentNode != parentNode) {
			...
			if (parentNode != null)
				msgs = ((InternalEObject)parentNode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParsetreePackage.VERB_PHRASE_NODE__PARENT_NODE, null, msgs);
			if (newParentNode != null)
				msgs = ((InternalEObject)newParentNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParsetreePackage.VERB_PHRASE_NODE__PARENT_NODE, null, msgs);
			msgs = basicSetParentNode(newParentNode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParsetreePackage.VERB_PHRASE_NODE__PARENT_NODE, newParentNode, newParentNode));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ParsetreePackage.VERB_PHRASE_NODE__CHILD_NODES:
				return ((InternalEList<?>)getChildNodes()).basicRemove(otherEnd, msgs);
			case ParsetreePackage.VERB_PHRASE_NODE__PARENT_NODE:
