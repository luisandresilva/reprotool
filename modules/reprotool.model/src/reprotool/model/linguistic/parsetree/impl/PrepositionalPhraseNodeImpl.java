...
public class PrepositionalPhraseNodeImpl extends EObjectImpl implements PrepositionalPhraseNode {
	...
	protected EClass eStaticClass() {
		return ParsetreePackage.Literals.PREPOSITIONAL_PHRASE_NODE;
	}
	...
	public EList<ParseNode> getChildNodes() {
		if (childNodes == null) {
			childNodes = new EObjectContainmentEList<ParseNode>(ParseNode.class, this, ParsetreePackage.PREPOSITIONAL_PHRASE_NODE__CHILD_NODES);
		}
		return childNodes;
	}
