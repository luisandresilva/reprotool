 ...
 * <ul>
 *   <li>{@link reprotool.model.linguistic.impl.SentenceObjectImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class SentenceObjectImpl extends SentencePartImpl implements SentenceObject {
	...
	protected EClass eStaticClass() {
		return LinguisticPackage.Literals.SENTENCE_OBJECT;
	}
		...
		if (object != null && object.eIsProxy()) {
			...
			if (object != oldObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LinguisticPackage.SENTENCE_OBJECT__OBJECT, oldObject, object));
			}
		}
		return object;
	}
	...
	public void setObject(Actor newObject) {
		...
		object = newObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LinguisticPackage.SENTENCE_OBJECT__OBJECT, oldObject, object));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LinguisticPackage.SENTENCE_OBJECT__OBJECT:
