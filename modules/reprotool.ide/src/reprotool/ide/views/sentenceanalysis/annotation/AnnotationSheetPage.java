package reprotool.ide.views.sentenceanalysis.annotation;
...
import reprotool.ide.views.sentenceanalysis.step.BoxContainer;
import reprotool.ide.views.sentenceanalysis.ISentenceAnalysisSheetPage;
import reprotool.ide.views.sentenceanalysis.step.ParamBox;
...
/**
 * Page of the sentence analysis view to show.
 * <p>
 ...
 *
 */
public class AnnotationSheetPage extends Page implements ISentenceAnalysisSheetPage {
	 ...
	 */
	public AnnotationSheetPage(AdapterFactoryEditingDomain editingDomain) {
	...
	public void createControl(Composite parent) {
		...
		boxContainer.getActionTypeBox().getComboViewer().addPostSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				...
				AnnotationSheetPage.this.boxContainer.layout();
			}
		});
	}
