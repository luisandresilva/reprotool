 ...
 * <ul>
 *   <li>{@link reprotool.txtspec.txtSpec.impl.DocumentImpl#getBlocks <em>Blocks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentImpl extends MinimalEObjectImpl.Container implements Document
{
  ...
  {
    return TxtSpecPackage.Literals.DOCUMENT;
  }
  ...
  public EList<Block> getBlocks()
  {
    if (blocks == null)
    {
      blocks = new EObjectContainmentEList<Block>(Block.class, this, TxtSpecPackage.DOCUMENT__BLOCKS);
    }
    return blocks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TxtSpecPackage.DOCUMENT__BLOCKS:
