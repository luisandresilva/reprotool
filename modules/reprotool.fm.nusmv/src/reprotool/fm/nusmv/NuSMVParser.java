...
/**
 * This class parses the variable names and values that are generated by the
 * NuSMV model checker when it generates a counter-example trace.
 * 
 * @author rudo
 */
public class NuSMVParser {
	...
	/**
	 * Process a variable name and value from the NuSMV output. This roughly
	 * corresponds to a single step in the reprotool counterExample model.
	 *  
	 * @param name	The variable name 
	 * @param value	The variable value	
	 * @param nusmvProject	The NuSMV project
	 * @param counterExample	The counterExample model we are generating
	 * @param branchingStep	an auxiliary map that helps us make sure we do not miss any steps.
	 */
