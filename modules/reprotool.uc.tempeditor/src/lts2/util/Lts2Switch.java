 ...
 * @generated
 */
public class Lts2Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Lts2Package modelPackage;
	...
	public Lts2Switch() {
		if (modelPackage == null) {
			modelPackage = Lts2Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Lts2Package.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Lts2Package.TRANSITIONAL_STATE: {
				TransitionalState transitionalState = (TransitionalState)theEObject;
				T result = caseTransitionalState(transitionalState);
				if (result == null) result = caseState(transitionalState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Lts2Package.TRANSITION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Transitional State</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Transitional State</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTransitionalState(TransitionalState object) {
		return null;
	}
