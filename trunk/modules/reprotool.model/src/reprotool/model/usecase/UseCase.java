 ...
 *   <li>{@link reprotool.model.usecase.UseCase#getPrecedingUseCases <em>Preceding Use Cases</em>}</li>
 * </ul>
 * </p>
 *
...
public interface UseCase extends ReqCover, TraceableEntity {
	...
	/**
	 * Returns the value of the '<em><b>Preceding Use Cases</b></em>' reference list.
	 * The list contents are of type {@link reprotool.model.usecase.UseCase}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Preceding Use Cases</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Preceding Use Cases</em>' reference list.
	 * @see reprotool.model.usecase.UsecasePackage#getUseCase_PrecedingUseCases()
	 * @model
	 * @generated
	 */
	EList<UseCase> getPrecedingUseCases();
