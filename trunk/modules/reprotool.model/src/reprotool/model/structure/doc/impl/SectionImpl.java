 ...
 * <ul>
 *   <li>{@link reprotool.model.structure.doc.impl.SectionImpl#getParagraphs <em>Paragraphs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SectionImpl extends EObjectImpl implements Section {
	...
	protected EClass eStaticClass() {
		return DocPackage.Literals.SECTION;
	}
	...
	public EList<Paragraph> getParagraphs() {
		if (paragraphs == null) {
			paragraphs = new EObjectResolvingEList<Paragraph>(Paragraph.class, this, DocPackage.SECTION__PARAGRAPHS);
		}
		return paragraphs;
	}
