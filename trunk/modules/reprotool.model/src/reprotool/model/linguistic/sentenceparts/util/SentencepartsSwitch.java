 ...
 * @generated
 */
public class SentencepartsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SentencepartsPackage.SUBJECT: {
			...
			case SentencepartsPackage.GOTO_TARGET: {
			...
			case SentencepartsPackage.SENTENCE_OBJECT: {
			...
			case SentencepartsPackage.VERB: {
			...
			case SentencepartsPackage.REPRESENTATIVE_OBJECT: {
			...
			case SentencepartsPackage.INDIRECT_OBJECT: {
