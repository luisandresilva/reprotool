 ...
 * <ul>
 *   <li>{@link reprotool.model.procases.impl.InternalActionImpl#getNextAction <em>Next Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InternalActionImpl extends EObjectImpl implements InternalAction {
	...
	protected EClass eStaticClass() {
		return ProcasesPackage.Literals.INTERNAL_ACTION;
	}
	...
	public EList<Action> getNextAction() {
		if (nextAction == null) {
			nextAction = new EObjectResolvingEList<Action>(Action.class, this, ProcasesPackage.INTERNAL_ACTION__NEXT_ACTION);
		}
		return nextAction;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcasesPackage.INTERNAL_ACTION__NEXT_ACTION:
