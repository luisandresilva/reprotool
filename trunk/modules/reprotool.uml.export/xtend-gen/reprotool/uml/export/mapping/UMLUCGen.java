  ...
  private void loadActors(final SoftwareProject swproj) {
    ...
    final Procedure1<Actor> _function = new Procedure1<Actor>() {
        public void apply(final Actor actor) {
          {
            org.eclipse.uml2.uml.Actor _createActor = UMLUCGen.this.factory.createActor();
            final org.eclipse.uml2.uml.Actor a = _createActor;
            a.setPackage(UMLUCGen.this.model);
            String _name = actor.getName();
            a.setName(_name);
            Pair<Actor,org.eclipse.uml2.uml.Actor> _operator_mappedTo = ObjectExtensions.<Actor, org.eclipse.uml2.uml.Actor>operator_mappedTo(actor, a);
            UMLUCGen.this.<Actor, org.eclipse.uml2.uml.Actor>operator_add(UMLUCGen.this.actorMap, _operator_mappedTo);
          }
        }
      };
    ...
    for (final UseCaseStep step : _steps) {
      {
        ...
        final Procedure1<Scenario> _function = new Procedure1<Scenario>() {
            public void apply(final Scenario ext) {
              UMLUCGen.this.processScenario(ext, u);
            }
          };
        ...
        final Procedure1<Scenario> _function_1 = new Procedure1<Scenario>() {
            public void apply(final Scenario variation) {
              UMLUCGen.this.processScenario(variation, u);
            }
          };
  ...
  public Model generateUMLUCModel(final SoftwareProject swproj) {
      ...
      final Procedure1<UseCase> _function = new Procedure1<UseCase>() {
          public void apply(final UseCase useCase) {
            UMLUCGen.this.processUseCase(useCase);
          }
        };
      ...
      final Procedure1<UseCase> _function_1 = new Procedure1<UseCase>() {
          public void apply(final UseCase useCase) {
            UMLUCGen.this.processUseCaseInclude(useCase);
          }
        };
