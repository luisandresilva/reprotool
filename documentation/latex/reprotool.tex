...
\usepackage[printonlyused]{acronym} % Package for acronyms.
	...
	\acrodef{RCP}[RCP]{Rich Client Platform}
	\acrodef{LTL}[LTL]{Linear Temporal Logic}
	\acrodef{CTL}[CTL]{Computational Tree Logic}
...
\lstdefinelanguage{NuSMVLang}{
 ndkeywords={MODULE, DEFINE, VAR, INIT, ASSIGN, TRUE, FALSE, CTLSPEC, LTLSPEC, FAIRNESS, AX, A, AG, AF, EF, U, boolean, next, init, case, esac, in},
...
%\newpage
  ...
  \include{chapter-umlExport}
  \include{chapter-lts}
  \include{chapter-linguistics}
  \include{chapter-future-work}
  \include{chapter-chronological-desc}  
  \appendix
  \include{appendix-list-of-plugins}
